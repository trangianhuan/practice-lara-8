            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold">
                        <div href="article" class="text-gray-900 dark:text-white">
                            Create article use "laravel-medialibrary"
                        </div>
                    </div>
                </div>
                    ...
                    <form action="/article" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="p-6">
                                ...
                                <input name="title" type='text' placeholder="Enter your title here" class="w-full mt-2 mb-6 px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-green-500" />

                                <label class="text-gray-600 font-light">Thumbnail</label>
                                    ...
                                    <div class="md:flex">
                                        <div class="w-full p-3">
                                            <div class="relative border-dotted h-48 rounded-lg border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                                                ...
                                                <input type="file" class="h-full w-full opacity-0" name="thumbnail2">
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
                            ...
                            <div class="p-6 border-l border-dashed">
                                <label class="text-gray-600 font-light"> &nbsp;</label><br/>

                                <button class="mt-2 py-2 px-4 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75">
                                    Save
                                </button>
                            </div>
